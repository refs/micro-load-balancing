...
type SayService interface {
	Hello(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*Response, error)
}
...
func (c *sayService) Hello(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*Response, error) {
...
func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		Hello(ctx context.Context, in *empty.Empty, out *Response) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) Hello(ctx context.Context, in *empty.Empty, out *Response) error {
